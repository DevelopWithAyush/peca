import { MobileViewSlide1Svg, MobileViewSlide2Svg, MobileViewSlide3Svg, MobileViewSlide4Svg, Slide1Background } from "@/assets/Svg";
...
const FirstPoster = () => {
  return (
    <div className="w-full h-auto relative top-[-60px] z-10 flex flex-col items-start justify-center">
      <Image
        src="/Images/slide1Image2.gif"
        alt=""
        width={187}
        height={190}
        className="z-0 relative top-[40px]"
      />
  ...
  return (
    <div className="w-full flex relative top-[-40px] flex-col items-center justify-center">
      <div className="flex flex-col w-auto items-center justify-center relative z-10">
        <p
          className="text-[#FFF566] w-[60%] text-[20px] font-jolly-lodger_400 -translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 leading-[110%] text-center text-balance"
          style={{
      ...
      <div className="relative left-[-40px] flex flex-col items-center justify-center w-auto ">
        <div className="flex flex-col items-center">
          <Image
            ...
            alt=""
            width={132}
            height={132} // Aspect ratio maintained with a square image
            className="relative top-[40px]"
          />
          <MobileViewSlide4Svg className="relative " />
        </div>
        <button
          className="text-[20px] font-jolly-lodger_400 tracking-[1.2px] px-4 py-2 text-[#FFF566] bg-[#079307] border-[4px] border-solid border-[#FFF566] rounded-[12px] relative top-[-10px] left-[15px]"
          style={{
            WebkitTextStrokeWidth: "3px",
            WebkitTextStrokeColor: "#F12E05",
            paintOrder: "stroke fill",
